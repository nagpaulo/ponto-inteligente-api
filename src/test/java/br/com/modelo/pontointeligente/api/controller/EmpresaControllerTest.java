...
public class EmpresaControllerTest {
    ...
    private static final Long ID = Long.valueOf(151);
    private static final String CNPJ = "11861136000102";
    private static final String RAZAO_SOCIAL = "Empresa KI";
    ...
    public void testBuscarEmpresaCnpjValido() throws Exception {
        ...
        mvc.perform(MockMvcRequestBuilders.get(BUSCAR_EMPRESA_CNPJ_URL+CNPJ)
                .accept(MediaType.APPLICATION_JSON).header("Cache-Control","no-cache"))
